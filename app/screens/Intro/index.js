    ...
    return (
      <Container>
          ...
          <View style={styles.topView}>
                <Image source={require('../../Images/kuda_intro_image.png')} style={styles.introimage} />
                
         </View> 

        <View style={styles.textViewIntro}>
        <Text style={styles.introText}>Welcome to your {'\n'}    mobile bank</Text>
        </View>
        ...
        <Text style={styles.textdark}>Have an account?</Text>      
       <TouchableOpacity
         onPress={ 
          ()=> this.props.navigation.navigate("SigninScreen")
        }
       >
        <Text style={styles.AlreadyLoggedinText}> Log In</Text>
       </TouchableOpacity>
